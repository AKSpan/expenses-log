        ...
        Plugin.prototype =
            {
                ...
                initHours: function () {
                    ...
                    for (var i = 0; i < 12; i++) {
                        ...
                        var fill = ((this.currentDate.format(hFormat) == i) ? "#363641" : 'transparent');
                    ...
                    if (!this.params.shortTime) {
                        for (var i = 0; i < 12; i++) {
                            ...
                            var fill = ((this.currentDate.format(hFormat) == (i + 12)) ? "#363641" : 'transparent');
                ...
                initMinutes: function () {
                    ...
                    for (var i = 0; i < 60; i++) {
                        ...
                        var color = ((this.currentDate.format("m") == i) ? "#363641" : 'transparent');
                ...
                createSVGClock: function (isHour) {
                    ...
                    var svgClockCenter = this.createSVGElement("circle", {r: '15', fill: '#363641'});
                ...
                _onSelectHour: function (e) {
                    if (!$(e.target).hasClass('disabled')) {
                        ...
                        $(parent.find('#h-' + value)).attr('fill', '#363641');
                ...
                _onSelectMinute: function (e) {
                    if (!$(e.target).hasClass('disabled')) {
                        ...
                        $(parent.find('#m-' + value)).attr('fill', '#363641');
                ...
                _centerBox: function () {
                    ...
                    this.$dtpElement.find('.dtp-content').css('top', '60px');//fix to my project
                },
                enableDays: function () {
